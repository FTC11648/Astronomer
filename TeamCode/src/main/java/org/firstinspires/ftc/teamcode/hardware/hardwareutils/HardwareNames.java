...
public class HardwareNames {
    ...
    public static final String leftElevatorActuator = "leftElevator";
    public static final String rightElevatorActuator = "rightElevator";

    //latching mechanism servo name
    public static final String latchingServo = "latch";
